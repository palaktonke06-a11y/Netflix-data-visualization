...
![Netflix Chart](movies_vs_tvshows.png)
   
2. Content Ratings (Pie chart)
![Netflix Chart](Content_Ratings_pie.png)
   
3. Movie Duration (Histogram)
![Netflix Chart](movie_duration_histogram.png)
   
4. Release year (Scatter plot)
![Netflix Chart](release_year_scatter.png)
